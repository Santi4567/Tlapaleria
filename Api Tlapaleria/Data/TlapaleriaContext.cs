...
namespace Api_Tlapaleria.Data
{
    public class TlapaleriaContext : DbContext
    {
        ...
        public DbSet<PresentationSupplierPriceHistory> PresentationSupplierPriceHistories { get; set; } // <-- Modelo de la tabla de ProductSupplierPriceHistory
        ...
        public DbSet<PendingOrderHistory> PendingOrderHistories { get; set; } // <-- Kardex de estados de Pedidos 
